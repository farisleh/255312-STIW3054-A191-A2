...
public class FollowingStat2{

    public List<Data> showAcc2() {

        String url = "https://github.com/zhamri?after=Y3Vyc29yOnYyOpK5MjAxOC0wOS0xMlQxMzoxMjoyMyswODowMM4CPHOZ&tab=followers";
