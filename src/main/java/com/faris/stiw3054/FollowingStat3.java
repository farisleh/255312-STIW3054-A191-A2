...
public class FollowingStat3{

    public List<Data> showAcc3() {

        String url = "https://github.com/zhamri?after=Y3Vyc29yOnYyOpK5MjAxNy0wOS0xM1QyMDoxMjowNyswODowMM4BoF9b&tab=followers";
